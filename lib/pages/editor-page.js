...
export default class EditorPage extends BaseContainer {
	...
	selectEditImage() {
		...
		if ( driverManager.currentScreenSize() === 'mobile' ) {
			editSelector = webdriver.By.css( '.is-mobile .editor-media-modal-detail__edit' );
		}
	...
	insertPaymentButton( { eyes, title = 'Button', description = 'Description', price = '1.00', allowQuantity = true, email = null } = {} ) {
		driverHelper.clickWhenClickable( this.driver, by.css( '.mce-wpcom-insert-menu button.mce-open' ) );
